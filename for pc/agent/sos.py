...
def _load_credentials():
    # Option A: hardcoded (simple, works immediately)
    sender   = ""   # ← paste your email here
    password = ""   # ← paste your 16-char app password here (no spaces)
    receiver = ""   # ← paste the recipient's email here
